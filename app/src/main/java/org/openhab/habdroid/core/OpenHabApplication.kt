...
class OpenHabApplication : MultiDexApplication() {
    ...
    override fun onCreate() {
        ...
        SharedPreferencesUtil.getInstance(this, "sp")
    }
    ...
    inner class DataSaverStateChangeReceiver : BroadcastReceiver() {
        ...
        override fun onReceive(context: Context, intent: Intent?) {
            ...
            dataSaverListeners.forEach { l ->
                l.onSystemDataSaverActiveStateChanged(
                    isSystemDataSaverActive
                )
            }
        }
    }
